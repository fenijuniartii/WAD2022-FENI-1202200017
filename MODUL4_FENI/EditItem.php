...
<body>
    ...
    <div class='d-flex justify-content-center align-items-start gap-5 mt-5'>
        ...
        <form action="update.php?id=<?php echo $selects['id_mobil']?>" method="POST" enctype='multipart/form-data'>
            ...
            <div class="mb-3">
                <label for="pembayaran"><b>Status Pembayaran</b></label>
                <div class="mb-3">
                    <input type="radio" name="pembayaran" id="pembayaran" value="Lunas" <?php ($selects["status_pembayaran"] == 'Yes') ? "checked" : ""?>>
                    <label for="Lunas">Lunas</label>
                    <input type="radio" name="pembayaran" id="pembayaran" value="Belum Lunas" <?php ($selects["status_pembayaran"] == 'No') ? "checked" : ""?>>
